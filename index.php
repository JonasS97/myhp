      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center" data-aos="fade-up" data-aos-delay="100">
            <h2><span><br> </span> Willkommen <br><span class="underlight"> Auf der Homepage </span><br><span>von</span><br> <span class="underlight"> Jonas Schneider
              </h2>
            <p>Life is a song, love the Musik.</p><p>&#119070; <!-- Unicode für G-Schlüssel --></p>
            <a href="https://www.youtube.com/watch?v=o87hNhgfZvI" target="_blank" class="btn-get-started">Mein lieblings Song<br></a>
          </div>
        </div>
      </div>
